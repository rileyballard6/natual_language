...
### 7. What variants are available for the Wireless Headphones?

**SQL:**
```sql
SELECT pv.name, pv.sku, pv.stock
FROM product_variants pv
JOIN products p ON p.id = pv.product_id
WHERE p.title = 'Wireless Headphones'
```

**Response:**
> The Wireless Headphones come in two variants: Black (SKU: WH-BLK, 40 in stock) and White (SKU: WH-WHT, 25 in stock).

---

### 8. List all orders placed by Alice
...
**Response:**
> Alice has placed 2 orders: Order #1 for $114.98 (completed on January 10, 2025) and Order #4 for $30.00 (completed on February 5, 2025).
